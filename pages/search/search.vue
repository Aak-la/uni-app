<template>
  <view class="search-container">
    <!-- 搜索导航组件 -->
    <NavBar @sendSearchData="_sendSearchData" :isSearch="isSearch" :parentVal="parentVal" @updataVal="parentVal=$event"></NavBar>
    <!-- 搜索包裹 -->
    ...
    <view v-else class="search-list-container">
      <Listitem  @saveSearchHistory="saveSearchHistory" :isShowLoading="isShowLoading" :articleList="searchList" @loadmore="loadmore" v-if="searchList.length"></Listitem>
